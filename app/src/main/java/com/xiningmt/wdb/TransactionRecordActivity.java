...
import rxh.hb.adapter.TransactionRecordLVAdapter;
...
public class TransactionRecordActivity extends BaseActivity {
    ...
    TransactionRecordLVAdapter adapter;
    List<TransactionRecordEntity> data = new ArrayList<>();
    ...
    public void getinformation(String pageNumber) {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (new RequestReturnProcessing(getApplicationContext(), code).processing() == 200) {
                                if (page == 1) {
                                    data.clear();
                                    data.addAll(JsonUtils.get_transaction_record(response.toString()));
                                    adapter = new TransactionRecordLVAdapter(data, getApplicationContext());
        ...
        VolleySingleton.getVolleySingleton(getApplicationContext().getApplicationContext())
