...
import rxh.hb.viewinterface.RiseNumberBase;
import rxh.hb.viewinterface.Utils;
...
public class RiseNumberTextView extends TextView implements RiseNumberBase {
	...
	private void runFloat() {
		...
		valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator valueAnimator) {
				if (flags) {
					setText(Utils.format("0.00")
							.format(Double.parseDouble(valueAnimator.getAnimatedValue().toString())));
	...
	private void runInt() {
		...
		valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator valueAnimator) {
				if (flags) {
					setText(Utils.format("#,###")
							.format(Integer.parseInt(valueAnimator.getAnimatedValue().toString())));
				} else {
