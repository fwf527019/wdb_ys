...
public class BannerFragmentTest extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view1 = inflater.inflate(R.layout.fragment_banner_test, container,
				false);
		convenientBanner = (ConvenientBanner) view1
	...
	public void initview() {
		mImageLoader = VolleySingleton.getVolleySingleton(getActivity())
				.getImageLoader();
