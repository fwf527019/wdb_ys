...
import rxh.hb.banner.adapter.CBPageAdapter;
import rxh.hb.banner.holder.CBViewHolderCreator;
import rxh.hb.banner.listener.CBPageChangeListener;
import rxh.hb.banner.listener.OnItemClickListener;
import rxh.hb.banner.view.CBLoopViewPager;
